...
\addcontentsline{toc}{chapter}{Instruction Set Reference}


add general remarks, description format, etc.
...
\instructionentry{Description}{
  Adds \texttt{RegR} and \texttt{RegB}, storing result in \texttt{RegR}.
